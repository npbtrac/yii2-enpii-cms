...
namespace enpii\enpiiCms\components\giix\model;
...
{
    public $db = 'db';
    public $ns = 'enpii\enpiiCms\models';
    public $nsCommon = 'enpii\enpiiCms\models';
    public $nsCommonBase = 'enpii\enpiiCms\models\base';
    public $tableName;
    public $modelClass;
    public $baseClass = 'enpii\enpiiCms\libs\NpActiveRecord';
    ...
    public $queryNs = 'enpii\enpiiCms\models\query';
    public $queryClass;
    public $queryBaseClass = 'enpii\enpiiCms\libs\NpActiveQuery';
    ...
    {
        return 'Giix (EnpiiCms) Model Generator';
    }
